...
if REDIS_URL:
    ...
    # Fine for local dev / a single-process deployment; swap in Redis for
    # multi-process / multi-instance production deployments.
    CHANNEL_LAYERS = {
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        ...
        "apps.accounts.authentication.CustomerTokenAuthentication",
    ),
